...
contract HODLV2 is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "HODL2";
    string private _symbol = "HODL2";
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    address public reservewallet = 0x1dD360d2d066cE977bd5337e2b3147a9be39F56D;
    address public teamwallet = 0x1dD360d2d066cE977bd5337e2b3147a9be39F56D;
    address public marketingwallet = 0x7Ccb4664b77B6810CE91fCa73edBC9266973a18e;
    address public reinvestwallet = 0x7Ccb4664b77B6810CE91fCa73edBC9266973a18e;
    ...
    uint256 public minTokenNumberUpperlimit = _tTotal.mul(5).div(100).div(10); // 0.1% max tx amount will trigger swap and add liquidity
    
    uint256 public rewardHardcap = 1000 ether;
    
    uint256 public claimgasfee = 0.005 ether;
    
    uint256 public buyBackUpperLimit = 1 * 10**18;
    bool public buyBackEnabled = false;
    uint256 public buyBackthresholdLimit = 5000000000 * 10**9;
    
    uint256 public mintoken = 1 * 10**9;
    ...
    // function changedevwallet(address payable _newaddress) public onlyOwner {
